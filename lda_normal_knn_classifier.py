...
class LdaNormalKNNClassifier(OCRClassifier):
    """
    Classifier for Optical Character Recognition using LDA and the Neighbors with K-NN classfier.
    """

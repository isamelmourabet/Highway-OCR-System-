# @brief PcaNormalBayesClassifier
# @author Isam EL Mourabet
# @date 2026
...
class PcaNormalBayesClassifier(OCRClassifier):
    """
    Classifier for Optical Character Recognition using PCA and the Bayes with Gaussian classfier.
    """
    ...
    def train(self, images_dict):
        ...
        # Perform PCA training (usando 61 componentes para conservar al menos el 95% de la varianza)
    ...
    def predict(self, img):
        ...
        feature_reduced = self.pca.transform(feature.reshape(1, -1))
